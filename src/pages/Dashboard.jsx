...
import { FileText, Clock, CheckCircle2, AlertTriangle, ArrowRight, User, Mail } from "lucide-react";
    ...
    <DashboardLayout>
      <div className="space-y-8">
        ...
        <motion.div
          ...
          className="surface-card p-6 border border-border rounded-lg"
        >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="grid gap-2 mt-3 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-foreground">{userUsername}</p>
                </div>
              </div>
            </div>
          </div>
